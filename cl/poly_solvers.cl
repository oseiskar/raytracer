...
/*
 * The original C code is from "Graph Gems"
 * https://github.com/erich666/GraphicsGems/blob/master/gemsiv/vec_mat/ray/solver.c
 */
...
int solveLinear(float c[2], float s[1])
{
if (isZero(c[1]))
    return 0;
s[0] = - c[0] / c[1];
